...
func showDetails(repoName string) {
	consoleLog("Showing details for:", repoName)
	// Here you can implement the logic to show more details about the repository
	// For now, we'll just log to the console
}

func main() {
	consoleLog("WASM main function started")
